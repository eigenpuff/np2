...
BOOL EncryptAndWriteFile(HWND hwnd,HANDLE hFile,LPCVOID preamble,LPCVOID data,DWORD len,LPDWORD written);
int ReadAndDecryptFile(HWND hwnd,HANDLE hFile,long len,void **lpdata,DWORD *cbdata);
